...
class Settings:
    ...
    def listen(self):
        ...
        self.parent.create_text(f'E - Использовать предмет', 24, (80, 350), (255, 0, 0), (200, 100, 50))
        self.parent.create_text(f'Стрелочки - выбор инвертаря', 24, (80, 400), (255, 0, 0), (200, 100, 50))
        self.parent.create_text(f'Правая кнопка мыши - сломать блок', 24, (650, 250), (255, 0, 0), (200, 100, 50))
        self.parent.create_text(f'Левая кнопка мыши - поставить блок', 24, (650, 300), (255, 0, 0), (200, 100, 50))
        self.parent.create_text(f'Дополнительно', 50, (450, 500), (0, 0, 0), (200, 100, 50))
